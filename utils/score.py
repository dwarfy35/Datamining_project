...
def nmi_continents(labels_pred, uniq_player_ids, data):
    ...
    nmi_score = normalized_mutual_info_score(continent_labels, labels_pred)
    return nmi_score
...
def nmi_regions(labels_pred, uniq_player_ids, data):
    ...
    nmi_score = normalized_mutual_info_score(region_labels, labels_pred)
    return nmi_score
...
def nmi_leagues(labels_pred, uniq_player_ids, data):
    ...
    nmi_score = normalized_mutual_info_score(league_labels, labels_pred)
    return nmi_score
